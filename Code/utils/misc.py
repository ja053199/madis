...
def save_model(args, epoch, encoder, model_without_ddp, optimizer, loss_scaler, fname=None, best_so_far=None):
...
def load_model(args, encoder, model_without_ddp, optimizer, loss_scaler):
    args.start_epoch = 0
    best_so_far = None
